...
SCAN_PROMPTS = {
    ...
    "prescription": (
        "Read this handwritten or printed medical prescription carefully. Provide:\n"
        "1. **Medicines Found** — list each medicine with name, dosage, frequency, duration\n"
        "2. **Special Instructions** — any specific instructions mentioned\n"
        "3. **Doctor Information** — doctor name, date if visible\n"
        "4. **Warnings** — drug interactions or important cautions\n"
        "5. **Severity** — Normal (routine) / Mild / Moderate / Severe\n"
        "6. **Confidence** — your confidence percentage in reading accuracy\n"
        "7. **اردو خلاصہ** — brief Urdu translation of the prescription"
    ),
}
